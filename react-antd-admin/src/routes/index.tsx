...
const PermissionList = lazy(() => import(/* webpackChunkName: "route-permission"*/ '@/pages/permission/list'));
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <WrapperRouteComponent element={<PermissionList />} titleId="title.permission.list" auth />,
      },
      {
        path: 'component/form',
